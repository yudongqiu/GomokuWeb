...
def tf_predict_u(state, zobrist_code, empty_spots_left, last_move, player):
    ...
    while len(interested_moves) == 1:
        ...
        if i_will_win(state, next_move, next_player):
    ...
    if next_player == -1: # if next is opponent, my win rate is negative of his
        result = -result
